    ...
    return <div className={"z-10 bg-background/80 bg"}>
        <div className={"flex flex-col pb-12 flex-grow mt-20 md:mt-40 max-w-content w-[85%] mx-auto"}>
            ...
            <div className={"mt-4"}>
                ...
                className={"hidden md:block"}/> Bereits seit den 1990er Jahren prüfen und errichten wir hauptberuflich
                Blitzschutzsysteme für Privat-
                und Gewerbekunden. <br className={"hidden md:block"}/>Da sich mit der Zeit gesetzliche Vorschriften und
                Normen ändern, bilden wir uns
                regelmäßig über Seminare und Fachtagungen weiter.<br/>
                <br/>
                Darüber hinaus sind wir seit 2006 Mitglied im Bundesverband Deutscher Sachverständiger des Handwerks
            ...
            <div className={"pb-14 pt-20"}>
                <VerticalTimeline layout={"2-columns"} lineColor={'#0293E4'} className={'timeLiner'}>
                    ...
                    >
                        ...
                        <div className={"timeLinerDescription"}>
                            Erfolgreicher Abschluss als geprüfter Blitzableitersetzer an der Landesgewerbeanstalt
                            Nürnberg
                        </div>
                    </VerticalTimelineElement>
                    ...
                    >
                        ...
                        <div className={"timeLinerDescription mb-4"}>
                            Erfolgreiche Absolvierung des Grund- und Aufbauseminars für Sachverständige des Handwerks
                            der HWK Ostthüringen (geprüft d. Akademie des HW, staatlich anerkannt)
                        </div>
                        <Image alt={"firmenhistorie"}
                               className={" border-layout-separator border h-full rounded-lg flex-grow max-w-[400px] w-full object-contain"}
                               src={image1}></Image>
                    </VerticalTimelineElement>
                    ...
                    <VerticalTimelineElement
                        ...
                        iconClassName={"timeLinerIcon"}
                    >
                        <div className="timeLinerHeader border-0 py-0 -mt-2 -ml-10 px-0"><span
                            className={"mr-2"}>🎉</span> 10 Jähriges Firmenjubiläum
                        </div>
                    </VerticalTimelineElement>
                    ...
                    >
                        ...
                        <div className={"timeLinerDescription"}>
                            Erklärung zur <b><i>befähigten Person</i></b> nach Betriebssicherheitsverordnung
                            (BetrSichV).
                            Nähere Informationen finden Sie <Link className={"text-accent-blue underline"}
                                                                  href={"/leiternpruefung"}>hier</Link>.
                        </div>
                    </VerticalTimelineElement>
                    ...
                    >
                        ...
                        <div className={"timeLinerDescription mb-4"}>
                            Zweiwöchige Weiterbildung zum Vertiefen der Kenntnisse in der Erstellung von technischen
                            Zeichnungen mithilfe von AutoCAD
                        </div>
                        <Image alt={"firmenhistorie"}
                               className={" border-layout-separator border h-full rounded-lg flex-grow max-w-[400px] w-full object-contain"}
                               src={image2}></Image>
                    ...
                    <VerticalTimelineElement
                        ...
                        iconClassName={"timeLinerIcon"}
                    >
                        <div className="timeLinerHeader border-0 py-0 -mt-2 px-0 -ml-10"><span
                            className={"mr-2"}>🎉</span> 20 Jähriges Firmenjubiläum
                        </div>
